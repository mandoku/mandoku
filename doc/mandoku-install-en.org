...
** Installing a package for Windows
   ...
   2. Download the =Mandoku= installation package [[file:data/mandoku-preview-2013-09-26.zip][mandoku-preview-2013-09-26.zip]] (165MB).
...
** Installing a package for Macintosh
   ...
   2. Download and open the =Mandoku= preview package [[file:data/mandoku-preview-2013-09-26.dmg][mandoku-preview-2013-09-26.dmg]] (55MB).
